...
* python 3.4 or later. pandas, numpy, matplotlib and openpyxl need to be installed and transitive requirements like scipy. You can instally these by saying: `pip3 install pandas`  etc
