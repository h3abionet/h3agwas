include {perform_mtag;GetSnpList;mergelistsnp;merge_allchroscore;extract_rs_formldsc;format_summary;renames_mtag} from './process.nf'
...
workflow mtag{
  ...
  main :
    ...
    perform_mtag(format_summary.out.collect(),channel.of(params.sumstat_head_n).combine(channel.of(params.sumstat_list_n)).combine(Channel.fromPath("${params.dir_ref_ld_chr}/",type:"dir")))
    renames_mtag(perform_mtag.out.combine(channel.of("$outputdir/mtag/")))
}
